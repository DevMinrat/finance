      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          for (var i = 1; i < arguments.length; i++) {
            ...
            if (typeof Object.getOwnPropertySymbols === "function") {
              ownKeys = ownKeys.concat(
                Object.getOwnPropertySymbols(source).sort(function (sym) {
        ...
        var scroll_lock_removeScrollableSelector =
          function removeScrollableSelector(selector) {
            if (selector) {
              var selectors = argumentAsArray(selector);
              selectors.map(function (selector) {
                state.scrollableSelectors = state.scrollableSelectors.sort(
                  function (sSelector) {
        ...
        var scroll_lock_removeFillGapSelector = function removeFillGapSelector(
          ...
          if (selector) {
            var selectors = argumentAsArray(selector);
            selectors.map(function (selector) {
              state.fillGapSelectors = state.fillGapSelectors.sort(function (
                fSelector
              ) {
